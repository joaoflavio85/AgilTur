      ...
      <div className="card" style={{ padding: 16, marginBottom: 12 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(220px, 1fr))', gap: 10, overflowX: 'auto' }}>
          {ETAPAS.map((etapa) => {
            ...
            return (
              <div key={etapa} style={{ border: '1px solid var(--border)', borderRadius: 10, background: 'var(--surface2)', minHeight: 180 }}>
                ...
                <div style={{ padding: 10, display: 'grid', gap: 8, maxHeight: 380, overflowY: 'auto' }}>
                  {cards.length === 0 ? (
        ...
        <table>
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={9}><div className="empty-state">Nenhuma proposta encontrada.</div></td></tr>
            ) : propostas.map((p) => {
                ...
                <td>
                  <div className="actions">
                    ...
                    <button
                      ...
                      title={podeExcluir ? 'Excluir proposta' : 'Exclusao permitida apenas em LEAD ou COTACAO'}
                    >
                      Excluir
                    </button>
